-- Teams: fifa_code is the natural key. Names live in team_name_translations (created in 000004).
...
-- Materialized table for group standings. Updated after each group stage match finishes.
