...
func (m *MockBoardService) GetBoardByID(ctx context.Context, boardID int64, userID string) (*domain.BoardDetails, error) {
...
func (m *MockBoardService) UpdateBoard(ctx context.Context, boardID int64, role domain.BoardMemberRole, payload dtos.UpdateBoardDto) error {
...
func (m *MockBoardService) DeleteBoard(ctx context.Context, boardID int64, role domain.BoardMemberRole) error {
	if m.DeleteBoardFunc != nil {
		return m.DeleteBoardFunc(ctx, boardID, role)
	}
